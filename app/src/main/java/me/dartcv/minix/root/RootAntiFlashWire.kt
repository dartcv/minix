...
internal fun RootAntiFlashState.toWireJson(): String = JSONObject()
...
internal fun decodeRootAntiFlashStateJson(payload: String): RootAntiFlashState {
    require(payload.length in 2..RootProtocol.MAX_ANTI_FLASH_STATE_JSON_CHARS) {
    ...
    val status = RootAntiFlashStatus.entries.firstOrNull { it.name == statusName }
