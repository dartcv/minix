...
object RootTargetCatalog {
    val entries: List<RootTargetChannel> = RootTargetChannel.entries.toList()

    val default: RootTargetChannel
        get() = entries.first()

    fun fromPackageName(packageName: String): RootTargetChannel? =
